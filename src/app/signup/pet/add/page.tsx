...
export default function AddPetPage() {
  ...
  const handleSubmit = () => {
    console.log('반려동물 정보:', formData);
    console.log('병원 정보:', hospitals);
    
    // 반려동물 정보를 localStorage에 저장
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <button
              ...
              className="w-full border-b border-gray-300 py-3 text-base text-left flex items-center justify-between text-gray-400"
            >
              <span>{formData.breed || '품종 입력'}</span>
